...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/ImageLoader.js":[function(require,module,exports) {
"use strict";
...
function returnContent(data) {
  ...
  //return all content
  var content = data.map(function (data) {
    if (data.status == 'fill') {
      return "\n    <div class=\"col\">\n      <div class=\"gallery__item \" data-type=\"show\" data-id=\"".concat(data.id, "\">\n        <a href=\"").concat(window.location.pathname, "?id=").concat(data.id - 1, "&").concat(data.name, "\">\n        <div class=\"gallery__item-image ").concat(data.type, "\">\n          <img src=\"").concat(data.thumbnail, "\" alt=\"\">\n        </div>\n        <div class=\"gallery__item-info\">\n          <div class=\"gallery__item-wrapper\">\n            <div class=\"gallery__item-title\"><span class=\"gallery__item-title--uppercase\">").concat(data.name, "</span>  / <br> ").concat(data.materials, "</div>\n            <div class=\"gallery__item-size\">").concat(data.size, "</div>\n          </div>\n          <div class=\"gallery__item-year\">\xA9 ").concat(data.year, "</div>\n        </div>\n        </a>\n      </div>\n    </div>\n    ");
    } else if (data.status == 'empty') {
      return "\n      <div class=\"col ".concat(data.status, "\">\n        <div class=\"gallery__item\" data-id=\"").concat(data.id, "\"> </div>\n      </div>\n    ");
    }
  });
  return content.join('');
} // function returnPictureContent (data, number) {
//   return `
//   <div class="container">
//     <div class="row">
//       <div class="col-3 align-flex-center">
//         <div class="picture__title">${data[number].name}</div>
//       </div>
//       <div class="col-9">
//         <div class="row">
//           <div class="col-12 col-lg-6 align-flex-center">
//             <div class="picture__content">
//               <div class="picture__materials">/ ${data[number].materials}</div>
//               <div class="picture__size">${data[number].size}</div>
//               <div class="picture__description">${data[number].text}</div>
//               <div class="picture__year">© ${data[number].year}</div>
//             </div>
//           </div>
//           <div class="col-12 col-lg-6 align-flex-center">
//             <div class="picture__image">
//               <img src="${data[number].image }" alt="">
//             </div>
//           </div>
//         </div>
//       </div>
...
function returnGetPicture(data, getId) {
  return "\n    <div class=\"container\">\n    <div class=\"row\">\n      <div class=\"col-5 col-xl-3\">\n        <div class=\"picture__title wow fadeIn\">".concat(data[getId].name, "</div>\n      </div>\n      <div class=\"col-12 col-md-7 col-xl-9\">\n        <div class=\"row\">\n          <div class=\"col-12 col-xl-6\">\n            <div class=\"picture__content\">\n              <div class=\"picture__materials\">/ ").concat(data[getId].materials, "</div>\n              <div class=\"picture__size\">").concat(data[getId].size, "</div>\n              <div class=\"picture__description\">").concat(data[getId].text, "</div>\n              <div class=\"picture__year\">\xA9 ").concat(data[getId].year, "</div>\n            </div>\n          </div>\n          <div class=\"col-12 col-xl-6\">\n            <div class=\"picture__image\">\n              <img src=\"").concat(data[getId].image, "\" alt=\"\">\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>  \n    ");
}

var ImageLoader = /*#__PURE__*/function () {
  function ImageLoader(data, container, picture, pictureContainer, getParams) {
  ...
  _createClass(ImageLoader, [{
    ...
    key: "renderPicture",
    value: function renderPicture(number) {
    ...
    value: function setup() {
      ...
      document.querySelectorAll('.gallery__item a').forEach(function (link) {
        link.addEventListener('click', _this.location);
      });
    }
  }, {
    key: "handlerClickPicture",
    value: function handlerClickPicture(e) {
    ...
    value: function (_location) {
      ...
      var initialPage = this.getAttribute('href');
    ...
    key: "hidePicture",
    value: function hidePicture() {
      this.$picture.classList.remove('picture--show');
      console.log('hide');
    }
  }, {
    key: "getPictureData",
    value: function getPictureData(e) {
      if (e.target.closest('.gallery__item')) {
        var galleryItem = e.target.closest('.gallery__item').dataset.id;
...
},{}],"json/gallery.json":[function(require,module,exports) {
module.exports = [{
  "id": "1",
  "status": "fill",
  "type": "vertical-big",
  ...
  "size": "40x40cm",
  "year": "2020",
  "image": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1618042712/gray_blsck_80x40_edugww.jpg",
  "thumbnail": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1617038456/1_a6ykix.jpg",
  "text": "When the computer absorbed design (and almost all our functions) the humanity of its practice was significantly emptied, not only in the nature of the technique but also in its orientation. Where there is a machine, there is, essentially, the absence of a human being."
}, {
  "id": "2",
  "status": "fill",
  ...
  "size": "40x40cm",
  "year": "2020",
  "image": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1618042707/glass_40x40_rcsmv4.jpg",
  "thumbnail": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1617038431/2_tk1a7j.jpg",
  "text": "When the computer absorbed design (and almost all our functions) the humanity of its practice was significantly emptied, not only in the nature of the technique but also in its orientation. Where there is a machine, there is, essentially, the absence of a human being."
}, {
  "id": "3",
  "status": "empty"
  ...
  "size": "40x40cm",
  "year": "2020",
  "image": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1618042704/phistashion_40x50_kt470g.jpg",
  "thumbnail": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1617038433/3_at1a61.jpg",
  "text": "When the computer absorbed design (and almost all our functions) the humanity of its practice was significantly emptied, not only in the nature of the technique but also in its orientation. Where there is a machine, there is, essentially, the absence of a human being."
}, {
  "id": "5",
  "status": "fill",
  ...
  "size": "40x40cm",
  "year": "2020",
  "image": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1618042706/white_red_60x40_efnton.jpg",
  "thumbnail": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1617038431/4_ymhugv.jpg",
  "text": "When the computer absorbed design (and almost all our functions) the humanity of its practice was significantly emptied, not only in the nature of the technique but also in its orientation. Where there is a machine, there is, essentially, the absence of a human being."
}, {
  "id": "6",
  "status": "empty"
  ...
  "size": "40x40cm",
  "year": "2020",
  "image": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1618042718/man1__60x45_nwxvqw.jpg",
  "thumbnail": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1617206905/Rectangle_4_ie0nxg.jpg",
  "text": "When the computer absorbed design (and almost all our functions) the humanity of its practice was significantly emptied, not only in the nature of the technique but also in its orientation. Where there is a machine, there is, essentially, the absence of a human being."
}, {
  "id": "8",
  "status": "fill",
  ...
  "size": "40x40cm",
  "year": "2020",
  "image": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1618042707/man2_70x50_doxayx.jpg",
  "thumbnail": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1617207268/Rectangle_22_i0jpoz.jpg",
  "text": "When the computer absorbed design (and almost all our functions) the humanity of its practice was significantly emptied, not only in the nature of the technique but also in its orientation. Where there is a machine, there is, essentially, the absence of a human being."
}, {
  "id": "9",
  "status": "empty"
  ...
  "size": "40x40cm",
  "year": "2020",
  "image": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1618042699/photo_2020-01-25_18.16.29_kannye.jpg",
  "thumbnail": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1617206905/Rectangle_55_q1skor.jpg",
  "text": "When the computer absorbed design (and almost all our functions) the humanity of its practice was significantly emptied, not only in the nature of the technique but also in its orientation. Where there is a machine, there is, essentially, the absence of a human being."
}, {
  "id": "11",
  "status": "fill",
  ...
  "size": "40x40cm",
  "year": "2020",
  "image": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1618042709/glass_40x50_sb8n65.jpg",
  "thumbnail": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1617206905/Rectangle_57_v983a7.jpg",
  "text": "When the computer absorbed design (and almost all our functions) the humanity of its practice was significantly emptied, not only in the nature of the technique but also in its orientation. Where there is a machine, there is, essentially, the absence of a human being."
}, {
  "id": "12",
  "status": "empty"
  ...
  "size": "40x40cm",
  "year": "2020",
  "image": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1618042713/goat_70x50_rwzlqx.jpg",
  "thumbnail": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1617038469/photo_6_iy70j8.jpg",
  "text": "When the computer absorbed design (and almost all our functions) the humanity of its practice was significantly emptied, not only in the nature of the technique but also in its orientation. Where there is a machine, there is, essentially, the absence of a human being."
}, {
  "id": "14",
  "status": "fill",
  ...
  "size": "40x40cm",
  "year": "2020",
  "image": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1618042749/girl_2_zuhykz.png",
  "thumbnail": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1617207559/Rectangle_12_zxrrom.png",
  "text": "When the computer absorbed design (and almost all our functions) the humanity of its practice was significantly emptied, not only in the nature of the technique but also in its orientation. Where there is a machine, there is, essentially, the absence of a human being."
}, {
  "id": "15",
  "status": "empty"
  ...
  "year": "2020",
  "image": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1618042713/goat_70x50_rwzlqx.jpg",
  "thumbnail": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1617207653/Rectangle_13_stvumb.jpg",
  "text": "When the computer absorbed design (and almost all our functions) the humanity of its practice was significantly emptied, not only in the nature of the technique but also in its orientation. Where there is a machine, there is, essentially, the absence of a human being."
}, {
  "id": "17",
  "status": "fill",
  ...
  "year": "2020",
  "image": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1618042749/girl_2_zuhykz.png",
  "thumbnail": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1617206905/Rectangle_15_kvcfta.jpg",
  "text": "When the computer absorbed design (and almost all our functions) the humanity of its practice was significantly emptied, not only in the nature of the technique but also in its orientation. Where there is a machine, there is, essentially, the absence of a human being."
}, {
  "id": "18",
  "status": "empty"
  ...
  "year": "2020",
  "image": "",
  "thumbnail": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1617206905/Rectangle_14_gjhcg5.jpg",
  "text": "When the computer absorbed design (and almost all our functions) the humanity of its practice was significantly emptied, not only in the nature of the technique but also in its orientation. Where there is a machine, there is, essentially, the absence of a human being."
}, {
  "id": "20",
  "status": "fill",
  ...
  "year": "2020",
  "image": "",
  "thumbnail": "https://res.cloudinary.com/alexanderkhabarov/image/upload/v1617206905/Rectangle_16_y7rayb.jpg",
  "text": "When the computer absorbed design (and almost all our functions) the humanity of its practice was significantly emptied, not only in the nature of the technique but also in its orientation. Where there is a machine, there is, essentially, the absence of a human being."
}];
...
exports.default = preloaderAnimation;

function preloaderAnimation() {
  if (document.querySelector('.preloader__progressbar')) {
    setTimeout(function () {
      document.querySelector('.preloader__progressbar-loader').classList.add('loader--fill');
    }, 1500);
    setTimeout(function () {
      document.querySelector('.preloader__progressbar').classList.add('hide-animation');
    }, 2000);
    setTimeout(function () {
...
},{}],"js/video-controller.js":[function(require,module,exports) {
"use strict";
...
function videoController() {
  ...
  var contactsButton = document.querySelector('#contactsButton');
  var artButton = document.querySelector('#artButton');
  var videoMain = document.querySelector('.video-main');
  var videoSecondary = document.querySelector('.video-secondary');
  var videoArt = document.querySelector('.video-art');
  var videoContacts = document.querySelector('.video-contacts');
  var videoAbout = document.querySelector('.video-about');

  if (aboutButton && contactsButton && artButton) {
    aboutButton.addEventListener('mouseover', function () {
      return showVideo(videoAbout);
    });
    aboutButton.addEventListener('mouseout', function () {
      return hideVideo(videoAbout);
    });
    artButton.addEventListener('mouseover', function () {
      return showVideo(videoArt);
    });
    artButton.addEventListener('mouseout', function () {
      return hideVideo(videoArt);
    });
    contactsButton.addEventListener('mouseover', function () {
      return showVideo(videoContacts);
    });
    contactsButton.addEventListener('mouseout', function () {
      return hideVideo(videoContacts);
    });
    ...
    function hideVideo(video) {
      ...
      videoMain.style.zIndex = "99";
      videoSecondary.play();
      videoSecondary.style.zIndex = "99"; // we need update this functional to remove listener
...
var _gallery = _interopRequireDefault(require("../json/gallery.json"));
...
window.onload = function () {
  (0, _preloader.default)(); //main-video

  var videoMain = document.querySelector('.video-main');
  var videoSecondary = document.querySelector('.video-secondary'); //play video then page is loaded

  if (videoSecondary) {
    setTimeout(function () {
      videoMain.play();
      videoSecondary.play();
      videoSecondary.addEventListener('playing', function () {
        setTimeout(function () {
          videoSecondary.style.zIndex = "-99";
          videoSecondary.pause();
          videoSecondary.currentTime = 0;
  ...
  (0, _videoController.default)(); //hide shadow after load

  setTimeout(function () {
    document.querySelector('.shadow').classList.remove('shadow--active');
  }, 250);
  var mainSwiper = new _swiper.default('.swiper-container', {
    slidesPerView: 3,
    spaceBetween: 40,
    speed: 500,
    loop: true
  ...
  if (document.querySelector('.gallery__container')) {
    var gallery = new _ImageLoader.default(_gallery.default, '.gallery__container', '.picture', '.picture__container', getParams);
...
},{"./ImageLoader":"js/ImageLoader.js","../json/gallery.json":"json/gallery.json","swiper":"node_modules/swiper/swiper.esm.js","./preloader":"js/preloader.js","./video-controller":"js/video-controller.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
